 ...
 */
@RestController
@RequestMapping("/api/officerStockInfo")
public class OfficerStockInfoController {
    ...
    public DataInfo<List<OfficerStockInfoDO>> search(@PathVariable Long officerId){
        List<OfficerStockInfoDO> items=this.officerStockInfoService.search(
